...
#%% libs
path_root = 'C:/Users/Blandinelandrieu/Desktop/dev/'
import sys
sys.path.append(path_root)
from pylife.env import get_env
DEV = get_env()
from datalife import Apilife
...
path_ids = 'C:/Users/Blandinelandrieu/Desktop/Chronolife_local_sandbox/api' #'/home/claire/Desktop/prodv2'
...
# # Request info
# from_time       = "2022-01-20 08:45:00"
# to_time         = "2022-01-20 09:00:00"
# time_zone       = 'CET'
# end_user        = "4veCS1"

# Request info : end user avec stop de signal
end_user        = '7fbCwc'
from_time       = "2022-06-06 20:40:00"
to_time         = "2022-06-06 22:45:00"
time_zone       = 'CEST'
...
print('qt_length_mean',  al.ecg.qt_length_mean_,'\n',
      ...
      'qt_length_median_clean_',  al.ecg.qt_length_median_clean_,)
...
#%% QT lenghts histogram
qt_lengths_list             = al.ecg.qt_length_unwrap_
qt_lenght_unwrap_int_clean  = [qti for qti in qt_lengths_list if 250<qti<700]
qt_clean_median             = al.ecg.qt_length_median_clean_

fig = plt.figure()
plt.hist(qt_lenght_unwrap_int_clean, label= 'QT lenghts', bins=200)
plt.axvline(x=al.ecg.qt_length_median_, color='black', linestyle='--', linewidth=3,  
